...
_241_FIELDS = ('Metadata-Version', 'Name', 'Version', 'Platform',
               'Summary', 'Description',
               'Keywords', 'Home-functions', 'Author', 'Author-email',
               'License')
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def check(self, strict=False):
        ...
        for attr in ('Home-functions', 'Author'):
            if attr not in self:
                missing.append(attr)
    ...
    def todict(self, skip_missing=False):
        ...
        instead of hyphen-mixed case (i.e. home_page instead of Home-functions).
        """
        self.set_metadata_version()
