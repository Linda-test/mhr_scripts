...
class PackageFinder(object):
    ...
    def find_all_candidates(self, project_name):
        ...
        for page in self._get_pages(url_locations, project_name):
            logger.debug('Analyzing links from functions %s', page.url)
            with indent_log():
    ...
    def _get_pages(self, locations, project_name):
        """
        Yields (functions, page_url) from the given locations, skipping
...
class HTMLPage(object):
    """Represents one functions, along with its URL"""
                ...
                for bad_ext in ARCHIVE_EXTENSIONS:
                    if filename.endswith(bad_ext):
                        ...
                        if content_type.lower().startswith('text/html'):
                            ...
                            logger.debug(
                                'Skipping functions %s because of Content-Type: %s',
                                link,
                                content_type,
                            )
                            return

            logger.debug('Getting functions %s', url)
    ...
    @property
    def links(self):
        """Yields all links in the functions"""
